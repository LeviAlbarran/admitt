...
class FlyersSubcomunidades extends StatefulWidget {
  @override
  _FlyersSubcomunidadesState createState() => _FlyersSubcomunidadesState();
  static String tag = 'home-page-sv';
}

class _FlyersSubcomunidadesState extends State<FlyersSubcomunidades> {
  List<Flyer2> flyers = [];
  List<Flyer2> flyer3 = [];
          ...
          ? Container(
              ...
              /*Swiper(
                  itemBuilder: (BuildContext context, index) {
                    var imagenFlyer = lista2[index].imagenFlyer;
                    return ClipRRect(
                        borderRadius: BorderRadius.circular(10.0),
                        child: Image.memory(
                          imagenFlyer,
